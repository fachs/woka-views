...
<div class="container mt-5">
	...
	<div class="row btn-area mt-5 mb-5 flex">
		<div class="col-lg col-sm-12">
			<form>
				@csrf
				<button class="btn btn-batal" formaction="{{ url('/new/pricing') }}">Kembali</button>
				<button class="btn btn-pesan float-end" formaction="{{ url('/new/gallery') }}">Simpan & Lanjutkan</button>
			</form>
		</div>
	</div>
</div>
